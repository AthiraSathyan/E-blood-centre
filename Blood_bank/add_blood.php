...
<form action="blood_action.php" method="post">
  <div class="container">
    <!-- <h1>Update </h1> -->
    <p style="color: red;">*    Please fill in this form to Add your  blood unit details.</p>
    <hr>
...
<label for="name"><b>Blood group A+</b></label>
    ...
    <input type="text"  name="a-" id="address" required>

    <label for="email"><b>Blood group B+ </b></label>
    <input type="text" name="b+" id="mobile" required>

    <label for="location"><b>Blood group B-</b></label>
    <input type="text"  name="b-" id="location" required>
    ...
    <label for="email"><b>Blood group O-</b></label>
    <input type="text"  name="o-" id="email" required>


    <!-- <p>By creating an account you agree to our <a href="#">Terms & Privacy</a>.</p> -->
    <button type="Register" class="registerbtn">Submit</button>
  </div>
