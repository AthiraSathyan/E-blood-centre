...
$sq="SELECT *
FROM blood_request
JOIN seeker ON (seeker.log_id = blood_request.user_id)
JOIN blood_bank ON (blood_bank.log_id = blood_request.bk_id AND blood_request.bk_id ='$id' AND blood_request.status='requested' )";
  ...
  <tr>
    ...
    <td> <a href="accept.php?email=<?php echo $data['email_id']; ?>&&id=<?php echo $data['r_id']; ?>" class="genric-btn success radius">Accept</a></td>
  </tr>
