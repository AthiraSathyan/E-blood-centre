...
<section class="banner-area other-page" >
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1>Register Your Blood Bank     here....</h1>
...
<form action="BloodBank_action.php" method="post">
  <div class="container">
    <h1>Register</h1>
    <p>Please fill in this form to create an account.</p>
    <hr>

    <label for="name"><b>center Name</b></label>
    <input type="text" placeholder="Enter Your Center Name" name="centername" id="name" required>

    <label for="name"><b>Register Number</b></label>
    <input type="text" placeholder="Enter Your Center Register Number" name="regnum" id="regnum" required>
