...
<form action="seeker_action.php" method="post">
  <div class="container">
    <h1>Register</h1>
    <p>Please fill in this form to create an account.</p>
    <hr>

    <label for="name"><b>seeker Name</b></label>
    <input type="text" placeholder="Enter Your  Name" name="seekername" id="name" required>
